...
namespace ACTest
{
    ...
    public static class RibbonButtonInfos
    {
        ...
        public static RibbonButtonEX LineBtn
        {
            get
            {
                ...
                lineBtn.SetImg("直线放样32.png");//设置按钮图片
                ////添加提示对象
        ...
        //        polylineBtn.SetImg("直线放样32.png");//设置按钮图片
        //        //添加提示对象
        //        RibbonToolTip toolTip = new RibbonToolTip();
        //        toolTip.Title = "多段线";
        ...
        //        circleCRBtn.SetImg("直线放样32.png");//设置按钮图片
    ...
    public class RibbonButtonEX : RibbonButton
    {
        ...
        public void SetImg(string imgFileName)
        {
            ...
            Uri uri = new Uri("pack://application:,,,/NewLoad;component/Images/" + imgFileName, UriKind.Absolute);
